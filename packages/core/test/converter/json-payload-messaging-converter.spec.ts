...
describe('JsonPayloadMessagingConverter', () => {
    ...
    describe('Logger Integration', () => {
        ...
        it('should accept LoggerInterface in constructor', () => {
            // ARRANGE & ACT
        ...
        it('should accept logger without requiring it to be called', async () => {
            // ARRANGE
            const converter = new JsonPayloadMessagingConverter<OrderEvent>(
                OrderEvent,
    ...
    describe('Custom Converter Integration', () => {
        it('should allow custom converter implementation', async () => {
            // ARRANGE
            class CustomConverter implements PayloadMessagingConverter<OrderEvent> {
                async convert(body: string): Promise<OrderEvent> {
                    const parsed = JSON.parse(body);
                    const event = new OrderEvent();
                    event.orderId = parsed.id;
                    event.customerId = parsed.customer;
                    event.amount = parsed.total;
                    return event;
                }
            }
