...
```bash
npm install @snow-tzu/nestjs-sqs-listener @aws-sdk/client-sqs
```
...
import { QueueListener, MessageContext } from '@snow-tzu/nestjs-sqs-listener';
...
import { SqsMessageListenerContainer, AcknowledgementMode } from '@snow-tzu/nestjs-sqs-listener';
import { SQSClient } from '@aws-sdk/client-sqs';
...
import { QueueListenerErrorHandler, MessageContext } from 'nestjs-sqs-listener';
...
```typescript
import { Injectable } from '@nestjs/common';
import { PayloadMessagingConverter } from 'nestjs-sqs-listener';
...
import { MessageContext } from 'nestjs-sqs-listener';
...
```typescript
import { Test } from '@nestjs/testing';
import { SqsMessageListenerContainer } from 'nestjs-sqs-listener';
