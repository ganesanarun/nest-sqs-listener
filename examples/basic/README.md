...
This example demonstrates the minimal setup required to get started with `@snow-tzu/nest-sqs-listener`. It shows a simple order processing system with a single SQS queue listener using automatic acknowledgement.
